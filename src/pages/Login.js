                ...
                <div className="flex flex-wrap justify-center my-36">
                    <div className="w-full max-w-sm">
                        <form action="" className="shadow-md bg-white rounded px-8 pt-6 pb-8 mb-4"
                          ...
                          focus:shadow-outline" placeholder="Username" onChange={e => this.username = e.target.value}
                                />
                                <label
                          ...
                          focus:shadow-outline" placeholder="Password" onChange={e => this.password = e.target.value}
                                />
                            </div>
